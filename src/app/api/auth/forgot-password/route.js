        ...
        await sendEmail({
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              <p style="font-size: 16px; color: #4A5568;">We received a request to reset your password for your flock account. Click the button below to reset it. This link will expire in 10 minutes.</p>
