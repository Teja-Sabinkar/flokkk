// Complete fix for /api/recently-viewed/route.js
...
// GET endpoint to fetch recently viewed items
  ...
  try {
    ...
    if (objectIds.length === 0) {
      ...
      const items = recentlyViewed.map(item => ({
        ...
        videoUrl: null, // No video URL available from metadata
        author: {
    ...
    const items = recentlyViewed
      .map(item => {
        ...
        return {
          ...
          videoUrl: post.videoUrl || null, // INCLUDE VIDEO URL
          author: {
